...
var StarsService = (function () {
    ...
    StarsService.prototype.getActions = function (students) {
        var _this = this;
        return new Observable_1.Observable.create(function (observer) {
            _this.getResource('actions').subscribe(function (actions) {
                _this.actions = actions.filter(function (a) { return _this.containsAny(students, a.Students, 'StudentId'); });
                if (_this.actions.length > 0) {
                    observer.next(_this.actions);
                }
                else {
                    observer.error("No records found");
                }
